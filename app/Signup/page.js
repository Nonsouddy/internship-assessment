...
export default function Signup() {
    return (
        <section className=' h-screen lg:flex  '>
          ...
          <div className="createBackground lg:block lg:w-1/2 hidden ">
            ...
            <div className='mr-10 ml-10  items-center  text-white text-4xl block text-center my-2 font-bold'>
                <div>Start turning your </div>
                       <div className='mt-2'> ideas into reality.</div>
                
            </div>
            <div className=' mr-10 ml-10  items-center  text-white text-m  text-center my-2 font-light'>
          ...
          {/* Signup left col */}
          <div className='h-full flex-col justify-center mt-10 px-6 sm:px-8 md:px-10 lg: lg:w-1/2 px-12 xl:px-14 2xl:px-16'>
              ...
              <div className='mt-10 text-center '>
                  <div className='text-gray text-m block font-sm'>
                    Already have an account? <a href='/Login' className="font-semibold text-blue-600 hover:text-blue-500">Login</a>
                  </div>
                </div>
